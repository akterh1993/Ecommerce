        ...
        <div className="flex w-full h-full relative ">
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
              ...
              {customerId && (
                <div className="flex justify-start items-center gap-3">
                  <div className="relative">
                    ...
                    <h2 className=" text-white text-base font-semibold">Hossain</h2>
                </div>
              )}
              <div
                onClick={() => setShow(!show)}
            ...
            <form className="flex gap-3">
              ...
              />
              <button className="shadow-lg bg-cyan-500 hover:shadow-cyan-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center cursor-pointer ">
                Send
              </button>
            </form>
          </div>
