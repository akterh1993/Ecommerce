...
const SellerDashboard = () => {
  ...
  const state = {
    series : [
      {
        name: "Orders",
        data : [34,65,343,65,34,65,343,65,34,65,343,65]
      },
      {
        name: "Revenue",
        data : [30,75,348,55,84,25,543,75,54,95,243,485]
      },
      {
        name: "Sellers",
        data : [40,65,38,85,74,55,53,25,34,75,73,75]
      },
    ],
    options : {
      color : [ '#181ee8', '#181ee8' ],
      ...
      stroke : {
        show : true,
        cruve : ['smooth', 'straight', 'stepline'],
        lineCap :'butt',
        colors : '#f0f0f0',
        width : .5,
        dashArray : 0
      ...
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
        <div className='flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#d0d2d6]'>
            <h2 className='text-3xl font-bold'>$6560</h2>
        ...
        <div className='flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3'>
          <div className='flex flex-col justify-start items-start text-[#d0d2d6]'>
            <h2 className='text-3xl font-bold'>30</h2>
            <span className='text-md font-medium'>Order Details</span>
          </div>
          <div className='w-[46px] h-[47px] rounded-full bg-[#e737ad1f] flex justify-center items-center text-xl'>
              <RiProductHuntLine className='text-[#f042ad] shadow-lg'/>
            </div>
        </div>
      </div>
      <div className='w-full flex flex-wrap mt-7'>
        ...
        <div className='w-full bg-[#283046] p-4 rounded-md text-[d0d2d6]'>
          <div className='flex justify-between items-center'>
            <h2 className='font-semibold text-lg text-[#d0d2d6] pb-3'>Recent Message</h2>
            ...
            <ol className='relative border-1 border-slate-600 ml-4'>
              <li className='mb-3 ml-6'>
                <div className='flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] bg-[#00d1e848] rounded-full z-10 '>
                  <img className='w-full rounded-full h-full shadow-lg' src='http://localhost:3000/images/admin.png' alt='images' />
                  </div>
                <div className='p-3 bg-slate-800 rounded-lg border border-slate-600 shadow-sm'>
                  <div className='flex justify-between items-center mb-2'>
                    <Link className='text-md font-normal' >Custommer</Link>
            ...
            <tbody>
              {
                ...
                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>#12345683</td>
                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>$750</td>
